...
| JavaScript | @base-ui/react | 1.7.0 | MIT |
| JavaScript | @base-ui/utils | 0.3.2 | MIT |
| JavaScript | @floating-ui/core | 1.8.0 | MIT |
...
| Python | colorlog | 6.12.0 | MIT License |
| Python | ctranslate2 | 4.8.1 | MIT |
| Python | flatbuffers | 25.12.19 | Apache 2.0 |
...
| Python | opencv-python | 5.0.0.93 | Apache 2.0 |
| Python | packaging | 26.3 | Apache-2.0 OR BSD-2-Clause |
| Python | pillow | 12.3.0 | MIT-CMU |
| Python | pluggy | 1.6.0 | MIT |
| Python | protobuf | 7.36.1 | 3-Clause BSD License |
| Python | pyclipper | 1.4.0 | MIT |
...
| Rust | block-buffer | 0.12.1 | MIT OR Apache-2.0 |
| Rust | block-padding | 0.4.2 | MIT OR Apache-2.0 |
...
| Rust | cbc | 0.2.1 | MIT OR Apache-2.0 |
| Rust | cc | 1.4.4 | MIT OR Apache-2.0 |
...
| Rust | cipher | 0.5.2 | MIT OR Apache-2.0 |
| Rust | combine | 4.6.8 | MIT |
| Rust | const-oid | 0.10.2 | Apache-2.0 OR MIT |
...
| Rust | crypto-common | 0.2.2 | MIT OR Apache-2.0 |
...
| Rust | digest | 0.11.3 | MIT OR Apache-2.0 |
...
| Rust | ecb | 0.2.1 | MIT OR Apache-2.0 |
| Rust | embed_plist | 1.2.2 | MIT OR Apache-2.0 |
| Rust | embed-resource | 3.0.11 | MIT |
| Rust | encoding_rs | 0.8.35 | (Apache-2.0 OR MIT) AND BSD-3-Clause |
...
| Rust | find-msvc-tools | 0.1.11 | MIT OR Apache-2.0 |
...
| Rust | hybrid-array | 0.4.14 | MIT OR Apache-2.0 |
...
| Rust | ico | 0.5.0 | MIT |
| Rust | icu_collections | 2.1.1 | Unicode-3.0 |
| Rust | icu_locale_core | 2.1.1 | Unicode-3.0 |
| Rust | icu_normalizer_data | 2.1.1 | Unicode-3.0 |
| Rust | icu_normalizer | 2.1.1 | Unicode-3.0 |
| Rust | icu_properties_data | 2.1.2 | Unicode-3.0 |
| Rust | icu_properties | 2.1.2 | Unicode-3.0 |
| Rust | icu_provider | 2.1.1 | Unicode-3.0 |
...
| Rust | inout | 0.2.2 | MIT OR Apache-2.0 |
...
| Rust | lopdf | 0.44.0 | MIT |
| Rust | markup5ever | 0.38.0 | MIT OR Apache-2.0 |
| Rust | md-5 | 0.11.0 | MIT OR Apache-2.0 |
...
| Rust | rangemap | 1.8.0 | MIT/Apache-2.0 |
...
| Rust | sha2 | 0.11.0 | MIT OR Apache-2.0 |
...
| Rust | syn | 3.0.4 | MIT OR Apache-2.0 |
...
| Rust | time-core | 0.1.8 | MIT OR Apache-2.0 |
| Rust | time-macros | 0.2.27 | MIT OR Apache-2.0 |
| Rust | time | 0.3.47 | MIT OR Apache-2.0 |
...
| Rust | unicode-bidi | 0.3.18 | MIT OR Apache-2.0 |
...
| Rust | uuid | 1.26.0 | Apache-2.0 OR MIT |
...
| Rust | wasip2 | 1.0.1+wasi-0.2.4 | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT |
...
| Rust | weezl | 0.2.1 | MIT OR Apache-2.0 |
...
| Rust | wit-bindgen | 0.46.0 | Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT |
...
- **LanguageTool Community 6.9-SNAPSHOT-20260901** — LGPL-2.1-or-later
  Fonte: https://languagetool.org/download/snapshots/LanguageTool-20260901-snapshot.zip
  Integridade: `sha256:518c60581bd1cb5c7f654db6843d4af4a15f91262d6683f419658135d9e69c81`
- **Eclipse Temurin JRE 21.0.12.1+1-LTS** — GPL-2.0-only WITH Classpath-exception-2.0
  Fonte: https://github.com/adoptium/temurin21-binaries/releases/download/jdk-21.0.12.1%2B1/OpenJDK21U-jre_x64_windows_hotspot_21.0.12.1_1.zip
  Integridade: `sha256:d35f31e712f0fcf6ac5a093edc90204fbff22f720ba3950bd09d331d5e621636`
